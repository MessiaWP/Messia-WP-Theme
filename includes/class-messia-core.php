...
final class Messia_Core {
	...
	private function define_constants(): void {
		...
		$this->define( 'MESSIA_NAMESPACE_FRONT', 'mccs' );
		$this->define( 'MESSIA_NAMESPACE_ADMIN', 'macs' );
		$this->define( 'MESSIA_LIST_SORT_SEARCH', $this->reserved_terms['messia_object_property'] );
		$this->define( 'MESSIA_MESSAGES', $messages );
		$this->define( 'MESSIA_WP_TEMPLATES_PREFIX', '/wp-templates' );
		$this->define( 'MESSIA_CODEPATH_PREFIX', '/includes' );
		$this->define( 'MESSIA_CODEPATH_PREFIX_CHILD', '/includes' );
		$this->define( 'MESSIA_CORE_ABSPATH', MESSIA_THEME_DIR . MESSIA_CODEPATH_PREFIX ); // e.g.: /wp-content/themes/messia/includes.
		$this->define( 'MESSIA_CORE_ABSPATH_CHILD', MESSIA_THEME_DIR_CHILD . MESSIA_CODEPATH_PREFIX_CHILD ); // e.g.: /wp-content/themes/messia-child/includes.
		$this->define( 'MESSIA_THEME_ABSPATH', dirname( MESSIA_FUNCTIONS_FILE ) . '/' );
		$this->define( 'MESSIA_THEME_VERSION', wp_get_theme()->version );
		$this->define( 'MESSIA_THEME_URL', get_template_directory_uri() );
		$this->define( 'MESSIA_THEME_URL_CHILD', get_stylesheet_directory_uri() );
		$this->define( 'MESSIA_THEME_MENU_PAGE_SLUG', 'messia-blog-settings' );
		$this->define( 'MESSIA_THEME_BLOG_SETTINGS_PRESET_NAME', 'messia_blog_settings_preset' );
		$this->define( 'MESSIA_THEME_SITE_SETTINGS_PRESET_NAME', 'messia_site_settings_preset' );
		$this->define( 'MESSIA_POSTMETA_CONSTRUCTED_PREFIX', '_segment_constructor_term_id_' );
		$this->define( 'MESSIA_POSTMETA_CONSTRUCTED_NAME', MESSIA_POSTMETA_CONSTRUCTED_PREFIX . '%Id%' );
		$this->define( 'MESSIA_POSTMETA_STUFF_NAME', '_stuff_meta_%name%_segment_term_id_%Id%' );
		$this->define( 'MESSIA_SITERATING_NAME', '_messia_site_rating_term_id_%Id%' );
		$this->define( 'MESSIA_THEME_NAMESPACE_BASE', 'Smartbits\Messia' );
		$this->define( 'MESSIA_THEME_NAMESPACE_BASE_CHILD', 'Smartbits\MessiaChild' );
		$this->define( 'MESSIA_DEMO_PACKAGE_COMMENT', 'Messia Demo Package' );
		$this->define( 'MESSIA_SHOP_URL', 'https://messiawp.com' );
		$this->define( 'MESSIA_SHOP_MY_ACCOUNT_URL', MESSIA_SHOP_URL . '/my-account' );
		$this->define( 'MESSIA_SHOP_PRODUCT_ID', 'Messia-Listing-WP-Theme' );
	}
